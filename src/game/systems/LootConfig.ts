...
export const LOOT_CONFIG = {
  [LootItemType.EXP_CANDY_S]: { xp: 2, color: 0x4a9eff, size: 8 },    // Blue, Small (Base Unit - Buffed to 2)
  [LootItemType.EXP_CANDY_M]: { xp: 4, color: 0x2ecc71, size: 10 },   // Green, Medium (Reduced from 10)
  [LootItemType.EXP_CANDY_L]: { xp: 10, color: 0xe74c3c, size: 12 },  // Red, Large (Reduced from 100)
