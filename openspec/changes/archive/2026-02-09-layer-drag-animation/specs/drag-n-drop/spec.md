...
**Description:** Implements smooth drag-and-drop interactions for list reordering using dnd-kit.
...
- **AND** the `onMoveLayer` callback should be triggered with the new index
