...
- **FROM**: `iron-passive`
- **TO**: `assault-vest-passive`

## MODIFIED Requirements

### Requirement: The Assault Vest Item MUST Increase Player Defense
**FROM**: `The Iron Item MUST Increase Player Defense`
...
**FROM**: `The Iron Item Stats MUST Scale Linearly`
...
**FROM**: `The Iron Item MUST Have Specific Metadata`
