...
## Purpose
Provide a survivor-style level-up selection system that presents players with randomized upgrade options when leveling up, replacing the simple level-up acknowledgment flow.
