# animation-tile-ui Specification

## Purpose
The animation-tile-ui capability provides the user interface components and logic specifically for browsing, previewing, and selecting animated tiles within the level editor.
